...
const _property_types_GlpkOptimizer = Dict{Symbol, String}(
    Symbol("optimizer_type") => "String",
    Symbol("msg_level") => "Int64",
)
OpenAPI.property_type(::Type{GlpkOptimizer}, name::Symbol) =
    Union{Nothing, eval(Base.Meta.parse(_property_types_GlpkOptimizer[name]))}
...
function OpenAPI.validate_property(::Type{GlpkOptimizer}, name::Symbol, val) end
