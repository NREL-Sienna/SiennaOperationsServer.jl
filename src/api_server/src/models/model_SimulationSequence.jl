...
Base.@kwdef mutable struct SimulationSequence <: OpenAPI.APIModel
    ...
    function SimulationSequence(initial_condition_chronology_type, feedforwards_by_model, )
        OpenAPI.validate_property(SimulationSequence, Symbol("initial_condition_chronology_type"), initial_condition_chronology_type)
        OpenAPI.validate_property(SimulationSequence, Symbol("feedforwards_by_model"), feedforwards_by_model)
        return new(initial_condition_chronology_type, feedforwards_by_model, )
    end
end # type SimulationSequence

const _property_types_SimulationSequence = Dict{Symbol,String}(Symbol("initial_condition_chronology_type")=>"String", Symbol("feedforwards_by_model")=>"Vector{Feedforwards}", )
OpenAPI.property_type(::Type{ SimulationSequence }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_SimulationSequence[name]))}
...
function OpenAPI.validate_property(::Type{ SimulationSequence }, name::Symbol, val)
end
