...
const _property_types_SystemCase = Dict{Symbol, String}(
    Symbol("category") => "String",
    Symbol("name") => "String",
    Symbol("descriptor_type") => "String",
)
OpenAPI.property_type(::Type{SystemCase}, name::Symbol) =
    Union{Nothing, eval(Base.Meta.parse(_property_types_SystemCase[name]))}
...
function OpenAPI.validate_property(::Type{SystemCase}, name::Symbol, val) end
