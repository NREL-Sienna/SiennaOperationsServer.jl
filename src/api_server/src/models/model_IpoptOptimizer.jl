...
const _property_types_IpoptOptimizer = Dict{Symbol, String}(
    Symbol("optimizer_type") => "String",
    Symbol("print_level") => "Int64",
    Symbol("max_cpu_time") => "Float64",
)
OpenAPI.property_type(::Type{IpoptOptimizer}, name::Symbol) =
    Union{Nothing, eval(Base.Meta.parse(_property_types_IpoptOptimizer[name]))}
...
function OpenAPI.validate_property(::Type{IpoptOptimizer}, name::Symbol, val) end
