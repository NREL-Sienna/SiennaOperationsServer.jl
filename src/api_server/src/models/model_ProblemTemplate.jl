...
const _property_types_ProblemTemplate = Dict{Symbol, String}(
    Symbol("network") => "NetworkModel",
    Symbol("devices") => "Vector{DeviceModel}",
    Symbol("services") => "Vector{ServiceModel}",
)
OpenAPI.property_type(::Type{ProblemTemplate}, name::Symbol) =
    Union{Nothing, eval(Base.Meta.parse(_property_types_ProblemTemplate[name]))}
...
function OpenAPI.validate_property(::Type{ProblemTemplate}, name::Symbol, val) end
