...
const _property_types_ScsOptimizer = Dict{Symbol, String}(
    Symbol("optimizer_type") => "String",
    Symbol("max_iters") => "Int64",
    Symbol("eps") => "Float64",
    Symbol("verbose") => "Bool",
)
OpenAPI.property_type(::Type{ScsOptimizer}, name::Symbol) =
    Union{Nothing, eval(Base.Meta.parse(_property_types_ScsOptimizer[name]))}
...
function OpenAPI.validate_property(::Type{ScsOptimizer}, name::Symbol, val) end
