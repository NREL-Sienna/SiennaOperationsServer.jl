...
Base.@kwdef mutable struct System <: OpenAPI.APIModel
    ...
    function System(uuid, name, description, forecast_initial_times, forecast_window_count, forecast_horizon, forecast_initial_timestamp, forecast_interval, time_series_resolution, )
        ...
        OpenAPI.validate_property(System, Symbol("forecast_initial_times"), forecast_initial_times)
        OpenAPI.validate_property(System, Symbol("forecast_window_count"), forecast_window_count)
        OpenAPI.validate_property(System, Symbol("forecast_horizon"), forecast_horizon)
        OpenAPI.validate_property(System, Symbol("forecast_initial_timestamp"), forecast_initial_timestamp)
        OpenAPI.validate_property(System, Symbol("forecast_interval"), forecast_interval)
        OpenAPI.validate_property(System, Symbol("time_series_resolution"), time_series_resolution)
        return new(uuid, name, description, forecast_initial_times, forecast_window_count, forecast_horizon, forecast_initial_timestamp, forecast_interval, time_series_resolution, )
    end
end # type System

const _property_types_System = Dict{Symbol,String}(Symbol("uuid")=>"String", Symbol("name")=>"String", Symbol("description")=>"String", Symbol("forecast_initial_times")=>"Vector{String}", Symbol("forecast_window_count")=>"Int64", Symbol("forecast_horizon")=>"Int64", Symbol("forecast_initial_timestamp")=>"String", Symbol("forecast_interval")=>"String", Symbol("time_series_resolution")=>"String", )
