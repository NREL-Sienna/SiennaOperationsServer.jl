...
const _property_types_SemiContinuousFeedforward = Dict{Symbol, String}(
    Symbol("component_type") => "String",
    Symbol("source") => "String",
    Symbol("affected_values") => "Vector{String}",
    Symbol("feedforward_type") => "String",
)
OpenAPI.property_type(::Type{SemiContinuousFeedforward}, name::Symbol) =
    Union{Nothing, eval(Base.Meta.parse(_property_types_SemiContinuousFeedforward[name]))}
...
function OpenAPI.validate_property(::Type{SemiContinuousFeedforward}, name::Symbol, val) end
