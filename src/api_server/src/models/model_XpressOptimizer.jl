...
const _property_types_XpressOptimizer = Dict{Symbol, String}(
    Symbol("optimizer_type") => "String",
    Symbol("MIPRELSTOP") => "Float64",
)
OpenAPI.property_type(::Type{XpressOptimizer}, name::Symbol) =
    Union{Nothing, eval(Base.Meta.parse(_property_types_XpressOptimizer[name]))}
...
function OpenAPI.validate_property(::Type{XpressOptimizer}, name::Symbol, val) end
