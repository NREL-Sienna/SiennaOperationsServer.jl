...
const _property_types_SimulationStatus = Dict{Symbol, String}(
    Symbol("status") => "String",
    Symbol("simulation_id") => "Int64",
    Symbol("name") => "String",
    Symbol("path") => "String",
    Symbol("start_time") => "String",
    Symbol("return_code") => "Int64",
    Symbol("exec_time_s") => "Float64",
    Symbol("worker_pid") => "Int64",
    Symbol("progress_events") => "Vector{SimulationProgressEvent}",
)
OpenAPI.property_type(::Type{SimulationStatus}, name::Symbol) =
    Union{Nothing, eval(Base.Meta.parse(_property_types_SimulationStatus[name]))}
