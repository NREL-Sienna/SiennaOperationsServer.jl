...
const _property_types_Simulation = Dict{Symbol, String}(
    Symbol("name") => "String",
    Symbol("models") => "SimulationModels",
    Symbol("sequence") => "SimulationSequence",
    Symbol("num_steps") => "Int64",
    Symbol("initial_time") => "String",
)
OpenAPI.property_type(::Type{Simulation}, name::Symbol) =
    Union{Nothing, eval(Base.Meta.parse(_property_types_Simulation[name]))}
...
function OpenAPI.validate_property(::Type{Simulation}, name::Symbol, val) end
