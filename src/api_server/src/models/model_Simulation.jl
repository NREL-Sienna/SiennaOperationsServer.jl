...
Base.@kwdef mutable struct Simulation <: OpenAPI.APIModel
    ...
    function Simulation(name, models, sequence, num_steps, )
        ...
        return new(name, models, sequence, num_steps, )
    end
end # type Simulation

const _property_types_Simulation = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("models")=>"SimulationModels", Symbol("sequence")=>"SimulationSequence", Symbol("num_steps")=>"Int64", )
