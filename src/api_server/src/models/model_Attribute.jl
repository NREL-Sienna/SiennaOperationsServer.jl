...
const _property_types_Attribute =
    Dict{Symbol, String}(Symbol("key") => "String", Symbol("val") => "Any")
OpenAPI.property_type(::Type{Attribute}, name::Symbol) =
    Union{Nothing, eval(Base.Meta.parse(_property_types_Attribute[name]))}
...
function OpenAPI.validate_property(::Type{Attribute}, name::Symbol, val) end
